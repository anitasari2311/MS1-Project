...
def addNewTemplate():
	if request.method == 'POST':
		...
		print(server_id)		
		print(report_judul)
		print(report_deskripsi)
		print(report_header)		
		print(report_footer) 		
		print(report_jmlTampilan) 
		print(report_periode)	
		print(report_createDate)
		print(report_userUpdate) 
		print(report_lastUpdate)
		print(report_aktifYN)
		print(org_id)
		print(ktgri_id)
		print(report_printAllYN)
		print(report_createdUser) 
		print(report_scheduleYN)
		print(report_tujuan)
